...
from examples.aircraft_data.Duffy_tilting_rotor import data as acdata
...
def show_outputs(prob):
    ...
    vars_list = ['ac|weights|MTOW', 'takeoff.OEW','ac|payload',
                 ...
                 'takeoff.OEW.W_gear', 'takeoff.OEW.W_equipment','takeoff.OEW.W_prop_fudged','takeoff.W_Motor','takeoff.W_Motor_Controller',
                    ...
                    for this_spec_energy in specific_energies:
                        try: 
                            ...
                            if run_type == 'optimization':
                                ...
                                prob.model.add_design_var('ac|geom|wing|AR',lower =  8, ref0 =  9.72, ref = 12, units = None)
                                prob.model.add_design_var('ac|geom|wing|S_ref',lower = 170, ref0 = 257.2, ref = 300, units = 'ft**2')
                                prob.model.add_design_var('ac|geom|vstab|S_ref',lower=50, ref0 = 50, ref = 60,units='ft**2')
                                prob.model.add_design_var('ac|geom|fuselage|length',lower=24, ref0 = 24, ref = 30 ,units='ft')
                                prob.model.add_design_var('ac|propulsion|propeller|diameter',lower=15, upper = 20, ref0 = 15, ref = 20, units='ft')
                                ...
                                prob.model.add_design_var('ac|propulsion|motor|rating',lower = 200, ref0 = 319.942, ref = 500, units='kW')
                                ...
                                # under 8 passangers
                                prob.model.add_design_var('ac|weights|MTOW', lower=100, ref0 = 1000, ref = 15000, units='lb')
                                prob.model.add_design_var('ac|geom|wing|AR',lower = 8, ref0 = 7, ref = 12, units = None)
                                ...
                                prob.model.add_design_var('ac|geom|fuselage|length',lower=50, ref0 = 50, ref = 60 ,units='ft')
