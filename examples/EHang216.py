...
from examples.aircraft_data.EHang216 import data as acdata
...
def run_eVTOL_type1_analysis(plots=True):
    num_nodes = 11
                    ...
                    for this_spec_energy in specific_energies:
                        try: 
                            ...
                            if run_type == 'optimization':
                                ...
                                prob.model.add_design_var('ac|geom|fuselage|length',lower= 2.5, ref0 = 2.5, ref = 3 ,units='m')
                                prob.model.add_design_var('ac|propulsion|propeller|diameter',lower= 5, ref0 = 5, ref = 6, units='ft')
                                prob.model.add_design_var('ac|propulsion|propeller|proprpm',lower= 300, ref0 = 800, ref = 2000,units='rpm')
                            ...
                            """
                            if write_logs:
                                filename_to_save = 'case_'+'EHang216_'+'SNOPT_'+'range'+str(design_range)+'_'+'battary'+str(spec_energy)+'_'+'payload'+str(payload)+'_'+'cruise'+str(cruise_speed)+'_'+'Rotor'+str(num_rotors)+'.sql'
                                filename_failed_to_save = 'case_'+'EHang216_'+'SNOPT_'+'range'+str(design_range)+'_'+'battary'+str(spec_energy)+'_'+'payload'+str(payload)+'_'+'cruise'+str(cruise_speed)+'_'+'Rotor'+str(num_rotors)+'_failed.sql'
