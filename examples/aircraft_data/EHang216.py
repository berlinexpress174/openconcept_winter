...
fuselage['length']      = {'value': 2.5, 'units': 'm'}
fuselage['width']       = {'value': 1.5, 'units': 'm'} 
fuselage['height']      = {'value': 1.76, 'units': 'm'} 
...
# ==WEIGHTS========================
weights = dict()
weights['MTOW']         = {'value': 1322, 'units': 'lb'}
weights['W_battery']    = {'value': 92, 'units': 'kg'}
weights['Payload']      = {'value': 485, 'units': 'lb'}
ac['weights'] = weights
...
propeller['num_blades']   = {'value': 2, 'units': None} # Number of blades, only for rotor calculation
