...
from examples.aircraft_data.CityAribus import data as acdata
                    ...
                    for this_spec_energy in specific_energies:
                        try: 
                            ...
                            if run_type == 'optimization':
                                ...
                                prob.model.add_design_var('ac|geom|fuselage|length',lower=6, upper = 12, ref0 = 6, ref = 12 ,units='m')
                                prob.model.add_design_var('ac|propulsion|propeller|diameter',lower=9.2, upper = 12, ref0 = 9.2, ref = 12, units='ft')
                                ...
                                prob.model.add_design_var('ac|geom|fuselage|length',lower=8, ref0 = 8, ref = 12 ,units='m')
                                prob.model.add_design_var('ac|propulsion|propeller|diameter',lower= 9.2, ref0 = 9.2, ref = 12, units='ft')
                            ...
                            """
                            if write_logs:
                                filename_to_save = 'case_'+'CityAirbus_'+'SNOPT_'+'range'+str(design_range)+'_'+'battary'+str(spec_energy)+'_'+'payload'+str(payload)+'_'+'cruise'+str(cruise_speed)+'_'+'Rotor'+str(num_rotors)+'.sql'
                                filename_failed_to_save = 'case_'+'CityAirbus_'+'SNOPT_'+'range'+str(design_range)+'_'+'battary'+str(spec_energy)+'_'+'payload'+str(payload)+'_'+'cruise'+str(cruise_speed)+'_'+'Rotor'+str(num_rotors)+'_failed.sql'
